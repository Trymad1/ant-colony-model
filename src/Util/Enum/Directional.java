...
// Список возможных направлений. Каждое направление имеет 3 точки им соответствующие, и значения,
// соотвесттвующие тому, как изменятся координаты точки, если она переместится по заданным направлениям

// Класс предназначен только для обьектов и сущностей размером в 1.
public enum Directional {
    ...
    /**
     * @return - противоположное текущему направление
     */
