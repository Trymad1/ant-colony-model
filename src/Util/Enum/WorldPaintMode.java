...
/**
 * Список возможных режимов отрисовки. Каждый обьект имеет свои флаги, 
 * регулирующий какие обьекты в мире будут отображены при текущем режиме отрисовки
 */
public enum WorldPaintMode {
    ...
    PHEROMONE_TO_ANTHILL("Феромон поиска колонии",true, true, true, true, false),
